...
final AngularMomentumUnits planckUnits =
    AngularMomentumUnits('h', '\u210E', null, 'h', 6.62607015e-34, false);

/// The Planck constant divided by 2 PI (a.k.a., 'h-bar') as units.
final AngularMomentumUnits hBarUnits = AngularMomentumUnits(
    'h-bar', '\u210F', null, 'h-bar', 1.054571817e-34, false);

// Constants.

/// The Planck constant.
const AngularMomentum planckConstant =
    AngularMomentum.constant(Double.constant(6.62607015e-34));
