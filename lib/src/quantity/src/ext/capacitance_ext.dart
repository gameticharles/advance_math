...
final CapacitanceUnits emuCapacitance =
    CapacitanceUnits('emu (capacitance)', null, null, null, 1.0e8, true);

/// The statfarad is the standard unit of capacitance in the cgs (centimeter/gram/second) system.
final CapacitanceUnits statfarads =
    CapacitanceUnits('statfarads', 'statF', null, null, 1.1127e-12, false);
