...
final EntropyUnits boltzmannUnit =
    EntropyUnits('Boltzmanns', 'kB', 'k', null, 1.3806503e-23, false);

/// The erg per clausius unit of entropy.
final EntropyUnits clausius =
    EntropyUnits('Clausius', null, 'Cl', null, 4.184, false);

/// The erg per kelvin unit of entropy.
final EntropyUnits ergPerKelvin =
    EntropyUnits.energyTemperature(ergs, TemperatureInterval.kelvins);
...
const Entropy boltzmannConstant =
    Entropy.constant(Double.constant(1.380649e-23));
