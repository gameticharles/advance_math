...
MagneticFluxUnits maxwells =
    MagneticFluxUnits('maxwells', null, null, null, 1.0e-8, true);

/// Unit poles as a unit.
MagneticFluxUnits unitPoles =
    MagneticFluxUnits('unit poles', null, null, null, 1.2566e-7, false);
