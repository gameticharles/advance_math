...
const Resistance characteristicImpedanceOfVacuum =
    Resistance.constant(Double.constant(376.730313668), uncert: 1.513018674951446e-10);
...
const Resistance vonKlitzingConstant = Resistance.constant(Double.constant(25812.807455555555));
