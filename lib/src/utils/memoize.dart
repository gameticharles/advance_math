...
class Memoize {
  ...
  static Memoized0<R> function0<R>(R Function() fn, {MemoizeOptions options = MemoizeOptions.unlimited}) => 
      Memoized0(fn, options: options);
  
  /// Creates a memoized version of a function with one argument.
  static Memoized1<A, R> function1<A, R>(R Function(A) fn, {MemoizeOptions options = MemoizeOptions.unlimited}) => 
      Memoized1(fn, options: options);
  
  /// Creates a memoized version of a function with two arguments.
  static Memoized2<A, B, R> function2<A, B, R>(R Function(A, B) fn, {MemoizeOptions options = MemoizeOptions.unlimited}) => 
      Memoized2(fn, options: options);
  
  /// Creates a memoized version of a function with three arguments.
  static Memoized3<A, B, C, R> function3<A, B, C, R>(R Function(A, B, C) fn, {MemoizeOptions options = MemoizeOptions.unlimited}) => 
      Memoized3(fn, options: options);
  
  /// Creates a memoized version of a function with four arguments.
  static Memoized4<A, B, C, D, R> function4<A, B, C, D, R>(R Function(A, B, C, D) fn, {MemoizeOptions options = MemoizeOptions.unlimited}) => 
      Memoized4(fn, options: options);
  
  /// Creates a memoized version of a function with five arguments.
  static Memoized5<A, B, C, D, E, R> function5<A, B, C, D, E, R>(R Function(A, B, C, D, E) fn, {MemoizeOptions options = MemoizeOptions.unlimited}) => 
  ...
  static Memoized1WithKey<A, R> function1WithKey<A, R>(
      R Function(A) fn, String Function(A) keyFn, {MemoizeOptions options = MemoizeOptions.unlimited}) => 
  ...
  static Memoized2WithKey<A, B, R> function2WithKey<A, B, R>(
      R Function(A, B) fn, String Function(A, B) keyFn, {MemoizeOptions options = MemoizeOptions.unlimited}) => 
      Memoized2WithKey(fn, keyFn, options: options);
  
  /// Creates a memoized version of a function with variable arguments.
  static MemoizedVarArgs<R> functionVarArgs<R>(R Function(List<dynamic>) fn, {MemoizeOptions options = MemoizeOptions.unlimited}) => 
  ...
  static MemoizedVarArgsWithKey<R> functionVarArgsWithKey<R>(
      R Function(List<dynamic>) fn, String Function(List<dynamic>) keyFn, {MemoizeOptions options = MemoizeOptions.unlimited}) => 
      MemoizedVarArgsWithKey(fn, keyFn, options: options);
  
  /// Creates a memoized version of an async function with one argument.
  static AsyncMemoized1<A, R> asyncFunction1<A, R>(Future<R> Function(A) fn, {MemoizeOptions options = MemoizeOptions.unlimited}) => 
      AsyncMemoized1(fn, options: options);
  
  /// Creates a memoized version of an async function with two arguments.
  static AsyncMemoized2<A, B, R> asyncFunction2<A, B, R>(Future<R> Function(A, B) fn, {MemoizeOptions options = MemoizeOptions.unlimited}) => 
...
class Memoized0<R> extends MemoizedBase<R> {
  ...
  R call({bool forceRecompute = false}) {
    ...
    final isTimeExpired = ttl != null && _computedAt != null && 
        DateTime.now().difference(_computedAt!) > ttl;
    
    if (isNotComputedYet || isExpired || forceRecompute || isTimeExpired || !_hasValue) {
      _value = _fn();
...
class Memoized1<A, R> extends MemoizedBase<R> {
  ...
  R call(A a, {bool forceRecompute = false}) {
    ...
    final isTimeExpired = ttl != null && entry != null && 
...
class Memoized5<A, B, C, D, E, R> extends MemoizedBase<R> {
  ...
  R call(A a, B b, C c, D d, E e, {bool forceRecompute = false}) {
    final key = '${a.hashCode}:${b.hashCode}:${c.hashCode}:${d.hashCode}:${e.hashCode}';
    final ttl = options.ttl;
    final entry = _cache.get(key);
...
extension MemoizeFunction1Ext<A, R> on R Function(A) {
  ...
  /// ```
  Memoized1<A, R> memoize({MemoizeOptions options = MemoizeOptions.unlimited}) => 
  ...
  /// ```
  Memoized1WithKey<A, R> memoizeWithKey(String Function(A) keyFn, {MemoizeOptions options = MemoizeOptions.unlimited}) => 
...
extension MemoizeFunction2Ext<A, B, R> on R Function(A, B) {
  /// Creates a memoized version of this function.
  Memoized2<A, B, R> memoize({MemoizeOptions options = MemoizeOptions.unlimited}) => 
      Memoized2(this, options: options);
  
  /// Creates a memoized version of this function with a custom key generator.
  Memoized2WithKey<A, B, R> memoizeWithKey(String Function(A, B) keyFn, {MemoizeOptions options = MemoizeOptions.unlimited}) => 
...
extension MemoizeFunction3Ext<A, B, C, R> on R Function(A, B, C) {
  /// Creates a memoized version of this function.
  Memoized3<A, B, C, R> memoize({MemoizeOptions options = MemoizeOptions.unlimited}) => 
...
extension MemoizeFunction4Ext<A, B, C, D, R> on R Function(A, B, C, D) {
  /// Creates a memoized version of this function.
  Memoized4<A, B, C, D, R> memoize({MemoizeOptions options = MemoizeOptions.unlimited}) => 
...
extension MemoizeFunction5Ext<A, B, C, D, E, R> on R Function(A, B, C, D, E) {
  /// Creates a memoized version of this function.
  Memoized5<A, B, C, D, E, R> memoize({MemoizeOptions options = MemoizeOptions.unlimited}) => 
...
extension MemoizeAsyncFunction1Ext<A, R> on Future<R> Function(A) {
  ...
  AsyncMemoized1<A, R> memoize({MemoizeOptions options = MemoizeOptions.unlimited}) => 
...
extension MemoizeAsyncFunction2Ext<A, B, R> on Future<R> Function(A, B) {
  /// Creates a memoized version of this async function.
  AsyncMemoized2<A, B, R> memoize({MemoizeOptions options = MemoizeOptions.unlimited}) => 
...
extension RecursiveMemoizeExt<A, R> on R Function(A) {
  ...
  /// ```
  Memoized1<A, R> memoizeRecursive({MemoizeOptions options = MemoizeOptions.unlimited}) {
