  ...
  group('Calculus', () {
    ...
    group('definite integrals', () {
      test('should calculate the definite integral correctly', () {
        ...
        check('defint(cos(x^x),1,2,x)', '-0.271136666209');
        check('defint(cos(x^log(sin(x))),2,3,x)', '0.805604089073');
        check('defint(log(2*cos(x/2)),-π,π,x)', '-0.000001118761'); //0
        check('defint(log(cos(x/2)),-π,π,x)',
            '-4.355173299368'); //-4.355172180607
        check('defint(log(x+1), -1, 1, x)',
            '-0.613705663447'); // -0.6137056388801095
        check('defint(log(x), 0, 1, x)', '-1');
        check('defint((x^2-3)/(-x^3+9x+1), 1, 3, x)',
            '0.732408192446'); //0.732408192445406585
        check('defint(x*(x-5)^(1/2),5,8)',
            '23.555890982933'); //23.555890982936999348
        check('defint(sqrt(4(x^2)+4), 0, 3)',
            '11.305279439738'); //11.305279439736
      });
    });
