...
void main() {
  ...
  group('Solve', () {
    test('should solve correctly', () {
      check('solve(x=y/3416.3333333333344, y)',
          '[(25000000000000000000/7317787101180601)*x]');
      check('solve(x, x)', '[0]');
      ...
      check('solve(2*x^2+1, x)', '[1/2i*sqrt(2),-1/2i*sqrt(2)]');
      check('solve(3*(x+5)*(x-4), x)', '[-5,4]');
      check('solve(3*(x+a)*(x-b), x)', '[-a,b]');
      check('solve(a*x^2+b, x)', '[i*a^(-0.5)*sqrt(b),-i*a^(-0.5)*sqrt(b)]');
      check('solve(x^2+2*x+1, x)', '[-1]');
      check('solve(-5 sqrt(14)x-14x^2 sqrt(83)-10=0,x)',
          '[(-1/28)*83^(-1/2)*(5*sqrt(14)+sqrt(350-560*sqrt(83))),((-5/28)*sqrt(14)+(1/28)*sqrt(350-560*sqrt(83)))*83^(-1/2)]');
      check('solve(-5*sqrt(14)x-14x^2*sqrt(83)-10x=0,x)',
          '[0,(-5/7+(-5/14)*sqrt(14))*83^(-1/2)]');
      check('solve(8*x^3-26x^2+3x+9,x)', '[3,-1/2,3/4]');
      check('solve(a*x^2+b*x+c, x)',
          '[(1/2)*(-b+sqrt(b^2-4*a*c))/a,((-1/2)*b+(-1/2)*sqrt(b^2-4*a*c))/a]');
      ...
      check(
          ...
          '[(2*sqrt(97)+2*sqrt(43))^(-1)*(sqrt(13)-sqrt(14)+sqrt(27-sqrt(13)*sqrt(14)-sqrt(14)*sqrt(13)-4*sqrt(97)*sqrt(3)*sqrt(101)-4*sqrt(43)*sqrt(3)*sqrt(101))),(2*sqrt(97)+2*sqrt(43))^(-1)*(sqrt(13)-sqrt(14)-sqrt(27-sqrt(13)*sqrt(14)-sqrt(14)*sqrt(13)-4*sqrt(97)*sqrt(3)*sqrt(101)-4*sqrt(43)*sqrt(3)*sqrt(101)))]');
      check('solve(a*y^2*x^3-1, x)',
          '[(y^(-2)/a)^(1/3),e^((2/3)*i*pi)*(y^(-2)/a)^(1/3),e^((4/3)*i*pi)*(y^(-2)/a)^(1/3)]');
      // check('solve((1/2)*sqrt(-4*x+4*y)-2+y, y)',
      //     '[5/2+(-1/2)*sqrt(9-4*x),5/2+(1/2)*sqrt(9-4*x)]');
      check('solve(log(a*x-c)-b=21, x)', '[(e^(21+b)+c)/a]');
      check('solve(x/(x-a)+4,x)', '[(4/5)*a]');
      check('solve(3*sin(a^2*x-b)-4,x)', '[a^(-2)*(asin(4/3)+b)]');
      check('solve(a*log(x^2-4)-4,x)', '[sqrt(4+e^(4/a)),-sqrt(4+e^(4/a))]');
      check('solve(x/(x^2+2*x+1)+4,x)',
          '[-9/8+(1/8)*sqrt(17),-9/8+(-1/8)*sqrt(17)]');
      check('solve((a*x^2+1),x)', '[i*a^(-0.5),-i*a^(-0.5)]');
      check('solve(sqrt(x)-2x+x^2,x)', '[0,1,0.3819660115986875]');
      check('solve((2x+x^2)^2-x,x)',
          '[-1+(-1/2)*sqrt(4/3+(28/3)*(299/2+(3/2)*sqrt(177))^(-3333333333333333/10000000000000000)+(1/3)*(299/2+(3/2)*sqrt(177))^0.3333333333333333)+(-1/4)*sqrt(32/3+(-112/3)*(299/2+(3/2)*sqrt(177))^(-3333333333333333/10000000000000000)+(-4/3)*(299/2+(3/2)*sqrt(177))^0.3333333333333333-8*(4/3+(28/3)*(299/2+(3/2)*sqrt(177))^(-3333333333333333/10000000000000000)+(1/3)*(299/2+(3/2)*sqrt(177))^0.3333333333333333)^(-1/2)),-1+(-1/2)*sqrt(4/3+(28/3)*(299/2+(3/2)*sqrt(177))^(-3333333333333333/10000000000000000)+(1/3)*(299/2+(3/2)*sqrt(177))^0.3333333333333333)+(1/4)*sqrt(32/3+(-112/3)*(299/2+(3/2)*sqrt(177))^(-3333333333333333/10000000000000000)+(-4/3)*(299/2+(3/2)*sqrt(177))^0.3333333333333333-8*(4/3+(28/3)*(299/2+(3/2)*sqrt(177))^(-3333333333333333/10000000000000000)+(1/3)*(299/2+(3/2)*sqrt(177))^0.3333333333333333)^(-1/2)),-1+(1/2)*sqrt(4/3+(28/3)*(299/2+(3/2)*sqrt(177))^(-3333333333333333/10000000000000000)+(1/3)*(299/2+(3/2)*sqrt(177))^0.3333333333333333)+(-1/4)*sqrt(32/3+(-112/3)*(299/2+(3/2)*sqrt(177))^(-3333333333333333/10000000000000000)+(-4/3)*(299/2+(3/2)*sqrt(177))^0.3333333333333333+8*(4/3+(28/3)*(299/2+(3/2)*sqrt(177))^(-3333333333333333/10000000000000000)+(1/3)*(299/2+(3/2)*sqrt(177))^0.3333333333333333)^(-1/2)),-1+(1/2)*sqrt(4/3+(28/3)*(299/2+(3/2)*sqrt(177))^(-3333333333333333/10000000000000000)+(1/3)*(299/2+(3/2)*sqrt(177))^0.3333333333333333)+(1/4)*sqrt(32/3+(-112/3)*(299/2+(3/2)*sqrt(177))^(-3333333333333333/10000000000000000)+(-4/3)*(299/2+(3/2)*sqrt(177))^0.3333333333333333+8*(4/3+(28/3)*(299/2+(3/2)*sqrt(177))^(-3333333333333333/10000000000000000)+(1/3)*(299/2+(3/2)*sqrt(177))^0.3333333333333333)^(-1/2))]');
      check('solve((5*x^4-2)/(x+1)/(x^2-1),x)',
          '[(2/5)^(1/4),e^((1/2)*i*pi)*(2/5)^(1/4),e^(i*pi)*(2/5)^(1/4),e^((3/2)*i*pi)*(2/5)^(1/4)]');
      check('solve(0=(x^(2)-2)/(e^(x)-1), x)', '[-sqrt(2),sqrt(2)]');
      check('solve(4/y^2=x^2+1,y)',
          '[(-2-2*x^2)^(-1)*sqrt(16+16*x^2),-(-2-2*x^2)^(-1)*sqrt(16+16*x^2)]');
      check('solve(1/(x+x^2), x)', '[]');
      check('solve(1/(x+x^2-1), x)', '[]');
      check('solve(-1+11000*(-100*(10+x)^(-1)+20)^(-2)*(10+x)^(-2), x)',
          '[-5+(-1/2)*sqrt(110),-5+(1/2)*sqrt(110)]');
      check('solve(x^3+y^3=3, x)',
          '[(3-y^3)^(1/3),e^((2/3)*i*pi)*(3-y^3)^(1/3),e^((4/3)*i*pi)*(3-y^3)^(1/3)]');
      ...
      check('solve(x^3+2x^2+3x-4=0,x)',
          '[-2/3+(-1/3)*(-73+3*sqrt(606))^0.3333333333333333+(5/3)*(-73+3*sqrt(606))^(-3333333333333333/10000000000000000),-2/3+1/6 - 4330127018922193/15000000000000000i*(-73+3*sqrt(606))^0.3333333333333333+(5/3)*(-0.5 + 0.8660254037844386i)^(-1)*(-73+3*sqrt(606))^(-3333333333333333/10000000000000000),-2/3+(-1/3)*(-73+3*sqrt(606))^0.3333333333333333*(-0.5 + 0.8660254037844386i)^2+(5/3)*(-73+3*sqrt(606))^(-3333333333333333/10000000000000000)*(-0.5 + 0.8660254037844386i)^(-2)]');
      check('solve(x*log(x),x)', '[1]');
      check(
          'solve((9x+x^2)^3+10800x+40x^4+4440x^2+720x^3+20(9*x+x^2)^2+8000,x) ',
          '[-5,-4]');
      check('solve((x^3-4)/(x^3+7x-11),x)',
          '[4^(1/3),e^((2/3)*i*pi)*4^(1/3),e^((4/3)*i*pi)*4^(1/3)]');
