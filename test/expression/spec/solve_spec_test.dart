  ...
  group('Solve', () {
    test('should solve correctly', () {
      ...
      check('solve(-5 sqrt(14)x-14x^2 sqrt(83)-10=0,x)',
          '[-1/28*sqrt(83)^(-1)*(5*sqrt(14)+sqrt(25*sqrt(14)^2-560*sqrt(83))),(-5/28*sqrt(14)+1/28*sqrt(25*sqrt(14)^2-560*sqrt(83)))*sqrt(83)^(-1)]');
      check('solve(-5*sqrt(14)x-14x^2*sqrt(83)-10x=0,x)',
          '[0,(-5/7-5/14*sqrt(14))*sqrt(83)^(-1)]');
      ...
      check(
          'solve(x/(x^2+2*x+1)+4,x)', '[-9/8+1/8*sqrt(17),-9/8-1/8*sqrt(17)]');
      check('solve((a*x^2+1),x)', '[i*a^(-0.5),-i*a^(-0.5)]');
      check('solve(sqrt(x)-2x+x^2,x)',
          '[0,1,1-1/2*sqrt(4/3+4/3*(11/2+i*3/2*sqrt(15))^(-3333333333333333/10000000000000000)+1/3*(11/2+i*3/2*sqrt(15))^0.3333333333333333)+1/4*sqrt(32/3-16/3*(11/2+i*3/2*sqrt(15))^(-3333333333333333/10000000000000000)-4/3*(11/2+i*3/2*sqrt(15))^0.3333333333333333-8*(4/3+4/3*(11/2+i*3/2*sqrt(15))^(-3333333333333333/10000000000000000)+1/3*(11/2+i*3/2*sqrt(15))^0.3333333333333333)^(-1/2))]');
